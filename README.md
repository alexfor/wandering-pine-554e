...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/wandering-pine-554e)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/wandering-pine-554e
```

A live public deployment of this template is available at [https://wandering-pine-554e.templates.workers.dev](https://wandering-pine-554e.templates.workers.dev)
